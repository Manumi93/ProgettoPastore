...
<head>
    ...
    <title>Geometra Umberto Pastore</title>
    <!-- google font -->
    ...
    <!-- favicon -->
    <link rel="icon" href="/media/immagini/favicon.png" type="image/png" />
        ...
        <div class="row align-items-center justify-content-end h-100  " id="ombra">
            <div class="col-12 col-md-6 layoutNavbar">
                ...
                <h3 class="titoloparagrafomobile d-block d-md-none"><b>lorem <br> aziendale <br> a portata di <br>
                        PMI</b></h3>
                <div>
                    <h4 class="paragrafo">Il geometra si occupa della progettazione e della direzione di lavori<br> in
                        ambito edile; svolge anche operazioni topografiche, come la <br>
                        misurazione di terreni e la stima di beni immobili.
                    </h4>
                </div>
            </div>
        </div>
    </div>
    <!-- fine immagine dopo navbar -->
                ...
                <div class="swiper mySwiper ">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide border  rounded-4">
                            <img class="rounded-4" src="/media/imgcarosello/lavoro1.jpg" alt="">
                        </div>
                        <div class="swiper-slide border rounded-4">
                            <img class="rounded-4" src="/media/imgcarosello/lavoro2.jpg" alt="">
                        </div>
                        <div class="swiper-slide border rounded-4">
                            <img class="rounded-4" src="/media/imgcarosello/lavoro3.jpg" alt="">
                        </div>
                        <div class="swiper-slide border rounded-4">
                            <img class="rounded-4" src="/media/imgcarosello/lavoro4.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid d-block d-md-none ">
        <div class="row">
            <div class="col-10 my-3">
                <img class="card1" src="/media/imgcard/card1.png" alt="">
            </div>
            <div class="col-10 my-5">
                <img class="card2" src="/media/imgcard/card2.png" alt="">
            </div>
            <div class="col-10 my-3">
                <img class="card3" src="/media/imgcard/card3.png" alt="">
            </div>
            <div class="col-10 my-3">
                <img class="card4" src="/media/imgcard/card4.png" alt="">
            </div>
        </div>
    </div>
    <!-- fine carosello -->
